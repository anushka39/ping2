...
import com.example.ping.activities.MainScreenActivity
...
class StatusUpdateFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        statusLayout.setOnClickListener{
            if(isAdded){
                (activity as MainScreenActivity).startNewActivity(REQUEST_CODE_PHOTO)
            }
        }
    }
    ...
    fun onUpdate() {
        ...
        firebaseDB.collection(DATA_USERS)
            ...
            .addOnFailureListener {
                progressLayout.visibility = View.GONE
                Toast.makeText(activity, "Status Update Failed", Toast.LENGTH_LONG).show()
