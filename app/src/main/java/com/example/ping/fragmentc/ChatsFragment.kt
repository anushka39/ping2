...
import com.example.ping.activities.ConversationActivity
import com.example.ping.adapters.ChatsAdapter
import com.example.ping.listenerc.ChatClicklListener
import com.example.ping.util.Chat
import com.example.ping.util.DATA_CHATS
...
class ChatsFragment : Fragment(), ChatClicklListener {
